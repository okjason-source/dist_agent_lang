...
1. **Check Existing Issues**: Search [GitHub Issues](https://github.com/distagentlang/dist_agent_lang/issues) to see if it's already reported.
...
1. **Check Existing Discussions**: See if it's been discussed in [GitHub Discussions](https://github.com/distagentlang/dist_agent_lang/discussions)
