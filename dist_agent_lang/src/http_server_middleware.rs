...
/// Convert Value back to HttpRequest
fn value_to_http_request(value: Value) -> Result<HttpRequest, String> {
    match value {
        Value::Map(map) => {
...
fn value_to_http_response(value: Value) -> Result<HttpResponse, String> {
    match value {
        Value::Map(map) => {
