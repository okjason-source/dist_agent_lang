...
**dist_agent_lang v1.0.XX is currently in beta/early release.** While it includes comprehensive security features, it has not yet undergone extensive real-world production testing. 
