...
> **📢 Beta Release v1.0.1:** dist_agent_lang is actively developed with consistent updates. This is a beta release - test thoroughly before production use. **Beta testing contributions appreciated!** 🙏
...
git clone https://github.com/your-org/dist_agent_lang.git
cd dist_agent_lang
...
```bash
# Via cargo
cargo install dist-agent-lang

# Via npm
npm install -g dist-agent-lang

# Via Homebrew (macOS)
brew install dist-agent-lang
```
...
# Check version
dal --version
# Expected: dist_agent_lang v1.0.1-beta
```
...
- 🐛 **Issues**: [GitHub Issues](https://github.com/your-org/dist_agent_lang/issues)
